...
<div class="bg-white rounded-xl shadow-soft p-6 mb-8">
    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
        <h2 class="text-xl font-semibold text-gray-800 mb-4 md:mb-0">Tambah Jurusan Baru</h2>
    ...
    <form action="/admin/majors/store" method="post" class="space-y-6">
        <?= csrf_field() ?>
        ...
        <div class="bg-gray-50 rounded-lg p-6 border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="<?= old('name', isset($oldInput['name']) ? $oldInput['name'] : '') ?>" required
                ...
                <div>
                    ...
                    <select id="is_active" name="is_active" required
                            class="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary">
                        <option value="1" <?= old('is_active', isset($oldInput['is_active']) ? $oldInput['is_active'] : '') == '1' ? 'selected' : '' ?>>Aktif</option>
                        <option value="0" <?= old('is_active', isset($oldInput['is_active']) ? $oldInput['is_active'] : '') == '0' ? 'selected' : '' ?>>Tidak Aktif</option>
                    </select>
                </div>
            </div>
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select id="riasec_match" name="riasec_match" required
                            class="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary">
                        <option value="" disabled selected>Pilih Kode RIASEC</option>
                        <option value="R" <?= old('riasec_match') == 'R' ? 'selected' : '' ?>>R (Realistic)</option>
                        <option value="I" <?= old('riasec_match') == 'I' ? 'selected' : '' ?>>I (Investigative)</option>
                        <option value="A" <?= old('riasec_match') == 'A' ? 'selected' : '' ?>>A (Artistic)</option>
                        <option value="S" <?= old('riasec_match') == 'S' ? 'selected' : '' ?>>S (Social)</option>
                        <option value="E" <?= old('riasec_match') == 'E' ? 'selected' : '' ?>>E (Enterprising)</option>
                        <option value="C" <?= old('riasec_match') == 'C' ? 'selected' : '' ?>>C (Conventional)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="mbti_match" name="mbti_match" required
                            class="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary">
                        <option value="" disabled selected>Pilih Kode MBTI</option>
                        <option value="ISTJ" <?= old('mbti_match') == 'ISTJ' ? 'selected' : '' ?>>ISTJ</option>
                        <option value="ISFJ" <?= old('mbti_match') == 'ISFJ' ? 'selected' : '' ?>>ISFJ</option>
                        <option value="INFJ" <?= old('mbti_match') == 'INFJ' ? 'selected' : '' ?>>INFJ</option>
                        <option value="INTJ" <?= old('mbti_match') == 'INTJ' ? 'selected' : '' ?>>INTJ</option>
                        <option value="ISTP" <?= old('mbti_match') == 'ISTP' ? 'selected' : '' ?>>ISTP</option>
                        <option value="ISFP" <?= old('mbti_match') == 'ISFP' ? 'selected' : '' ?>>ISFP</option>
                        <option value="INFP" <?= old('mbti_match') == 'INFP' ? 'selected' : '' ?>>INFP</option>
                        <option value="INTP" <?= old('mbti_match') == 'INTP' ? 'selected' : '' ?>>INTP</option>
                        <option value="ESTP" <?= old('mbti_match') == 'ESTP' ? 'selected' : '' ?>>ESTP</option>
                        <option value="ESFP" <?= old('mbti_match') == 'ESFP' ? 'selected' : '' ?>>ESFP</option>
                        <option value="ENFP" <?= old('mbti_match') == 'ENFP' ? 'selected' : '' ?>>ENFP</option>
                        <option value="ENTP" <?= old('mbti_match') == 'ENTP' ? 'selected' : '' ?>>ENTP</option>
                        <option value="ESTJ" <?= old('mbti_match') == 'ESTJ' ? 'selected' : '' ?>>ESTJ</option>
                        <option value="ESFJ" <?= old('mbti_match') == 'ESFJ' ? 'selected' : '' ?>>ESFJ</option>
                        <option value="ENFJ" <?= old('mbti_match') == 'ENFJ' ? 'selected' : '' ?>>ENFJ</option>
                        <option value="ENTJ" <?= old('mbti_match') == 'ENTJ' ? 'selected' : '' ?>>ENTJ</option>
                    </select>
                </div>
            </div>
            ...
            <div class="mt-4">
                ...
                <textarea id="description" name="description" rows="3" required
                          class="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary"><?= old('description') ?></textarea>
            ...
            <div class="mt-4">
                ...
                <textarea id="full_description" name="full_description" rows="5" 
                          class="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary"><?= old('full_description') ?></textarea>
        ...
        <div class="bg-gray-50 rounded-lg p-6 border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="degree_types" name="degree_types" value="<?= old('degree_types') ?>"
                ...
                <div>
                    ...
                    <input type="text" id="study_duration" name="study_duration" value="<?= old('study_duration') ?>"
            ...
            <div class="mt-4">
                ...
                <textarea id="core_subjects" name="core_subjects" rows="3"
                          class="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary"><?= old('core_subjects') ?></textarea>
        ...
        <div class="bg-gray-50 rounded-lg p-6 border border-gray-100">
            ...
            <div>
                ...
                <textarea id="career_prospects" name="career_prospects" rows="3" required
                          class="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary"><?= old('career_prospects') ?></textarea>
            ...
            <div class="mt-4">
                ...
                <input type="text" id="industry_sectors" name="industry_sectors" value="<?= old('industry_sectors') ?>"
            ...
            <div class="mt-4">
                ...
                <textarea id="future_trends" name="future_trends" rows="3"
                          class="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary"><?= old('future_trends') ?></textarea>
        ...
        <div class="bg-gray-50 rounded-lg p-6 border border-gray-100">
            ...
            <div>
                ...
                <textarea id="compatibility_reason" name="compatibility_reason" rows="3"
                          class="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary"><?= old('compatibility_reason') ?></textarea>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    <input type="number" 
                                           ...
                                           value="<?= old('personality_mappings[' . $type['id'] . ']') ?? '0' ?>"
                                           min="0" 
                                           max="100"
