...
<div class="bg-white rounded-xl shadow-soft p-6 mb-8">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-gray-800">Tambah Tipe Kepribadian</h2>
    ...
    <form action="/admin/personality-types/store" method="post" class="space-y-6">
        <?= csrf_field() ?>
                    ...
                    <div class="flex space-x-4">
                        <div class="flex items-center">
                            <input type="radio" id="introvert" name="introvert_extrovert" value="I" 
                                   <?= old('introvert_extrovert') === 'I' ? 'checked' : '' ?> 
                        ...
                        <div class="flex items-center">
                            <input type="radio" id="extrovert" name="introvert_extrovert" value="E" 
                                   <?= old('introvert_extrovert') === 'E' ? 'checked' : '' ?> 
                                   class="mr-2 text-primary focus:ring-primary">
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="personality_description" name="personality_description" rows="5"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-primary"
                              placeholder="Masukkan deskripsi tipe kepribadian"><?= old('personality_description') ?></textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="strengths" name="strengths" rows="4"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-primary"
                              placeholder="Masukkan kekuatan (satu per baris)"><?= old('strengths') ?></textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="development_areas" name="development_areas" rows="4"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-primary"
                              placeholder="Masukkan area pengembangan (satu per baris)"><?= old('development_areas') ?></textarea>
                    ...
                    <?php foreach ($majors as $major): ?>
                        <div class="flex items-start">
                            <input type="checkbox" id="major_<?= $major['id'] ?>" name="major_recommendations[]" value="<?= $major['id'] ?>"
                                  <?= is_array(old('major_recommendations')) && in_array($major['id'], old('major_recommendations')) ? 'checked' : '' ?>
